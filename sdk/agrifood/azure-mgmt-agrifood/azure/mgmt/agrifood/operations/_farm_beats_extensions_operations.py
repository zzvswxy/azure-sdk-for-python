...
def build_list_request(
    ...
    **kwargs: Any
    ...
    if farm_beats_extension_ids is not None:
        _params['farmBeatsExtensionIds'] = [_SERIALIZER.query("farm_beats_extension_ids", q, 'str') if q is not None else '' for q in farm_beats_extension_ids]
    if farm_beats_extension_names is not None:
        _params['farmBeatsExtensionNames'] = [_SERIALIZER.query("farm_beats_extension_names", q, 'str') if q is not None else '' for q in farm_beats_extension_names]
    ...
    if publisher_ids is not None:
        _params['publisherIds'] = [_SERIALIZER.query("publisher_ids", q, 'str') if q is not None else '' for q in publisher_ids]
