...
class ArmRollingUpgradeMonitoringPolicy(msrest.serialization.Model):
    ...
    :ivar failure_action: The activation Mode of the service package. Possible values include:
     "Rollback", "Manual".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword failure_action: The activation Mode of the service package. Possible values include:
         "Rollback", "Manual".
...
class CertificateDescription(msrest.serialization.Model):
    ...
    :ivar x509_store_name: The local certificate store location. Possible values include:
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword x509_store_name: The local certificate store location. Possible values include:
         "AddressBook", "AuthRoot", "CertificateAuthority", "Disallowed", "My", "Root", "TrustedPeople",
         "TrustedPublisher".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword upgrade_mode: The upgrade mode of the cluster when new Service Fabric runtime version
         is available. Possible values include: "Automatic", "Manual". Default value: "Automatic".
...
class ClusterCodeVersionsResult(msrest.serialization.Model):
    ...
    :ivar environment: Indicates if this version is for Windows or Linux operating system. Possible
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword environment: Indicates if this version is for Windows or Linux operating system.
...
class ManagedIdentity(msrest.serialization.Model):
    ...
    :vartype tenant_id: str
    :ivar type: The type of managed identity for the resource. Possible values include:
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword type: The type of managed identity for the resource. Possible values include:
         "SystemAssigned", "UserAssigned", "SystemAssigned, UserAssigned", "None".
...
class Notification(msrest.serialization.Model):
    ...
    :ivar notification_category: Required. The category of notification. Possible values include:
     "WaveProgress".
    :vartype notification_category: str or ~azure.mgmt.servicefabric.models.NotificationCategory
    :ivar notification_level: Required. The level of notification. Possible values include:
     "Critical", "All".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword notification_category: Required. The category of notification. Possible values
         include: "WaveProgress".
        :paramtype notification_category: str or ~azure.mgmt.servicefabric.models.NotificationCategory
        :keyword notification_level: Required. The level of notification. Possible values include:
         "Critical", "All".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword notification_channel: Required. The notification channel indicates the type of
         receivers subscribed to the notification, either user or subscription. Possible values include:
         "EmailUser", "EmailSubscription".
