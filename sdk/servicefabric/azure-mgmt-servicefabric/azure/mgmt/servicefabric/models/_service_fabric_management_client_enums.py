...
class AddOnFeatures(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ArmServicePackageActivationMode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ArmUpgradeFailureAction(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
    """The activation Mode of the service package
    """
...
class ClusterEnvironment(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ClusterVersionsEnvironment(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):

    WINDOWS = "Windows"
    LINUX = "Linux"

class DurabilityLevel(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class NotificationCategory(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class NotificationChannel(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class ReliabilityLevel(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class SfZonalUpgradeMode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class StoreName(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
...
class VmssZonalUpgradeMode(with_metaclass(CaseInsensitiveEnumMeta, str, Enum)):
